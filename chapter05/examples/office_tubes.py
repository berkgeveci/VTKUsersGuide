#!/usr/bin/env python
"""Multiple streamtubes seeded from a point cloud in office data."""
import os
...
# Seed points for multiple streamlines.
...
# Wrap the streamlines with tubes.
